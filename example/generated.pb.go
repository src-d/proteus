...
func (m *MyDuration) GetDuration() time.Duration {
	if m != nil {
		return m.Duration
	}
	return 0
...
func (m *MyDuration) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
var fileDescriptorGenerated = []byte{
	...
	,
}
